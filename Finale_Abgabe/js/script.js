...
let currentCard; // ist immer die aktuell oberste Karte auf dem Ablagestapel
let currentPlayer; // zeigt an, ob der Spieler gerade Spielzüge ausführen darf oder ob der Gegner dran ist
let alreadyTookCard = false; // zeigt an, ob schon eine Karte aufgenommen wurde
...
function opponent() {
    let couldLay = false; // zeigt an, ob der Gegner eine Karte legen konnte
